...
$_['text_redeem']   = 'Para utilizar este vale presentes anote o código: <b>%s</b>.<br />Agora clique no link abaixo e faça a compra dos produtos que você desejar!<br /><b>Importante:</b> Se o valor total do seu pedido ultrapassar o valor do vale presentes que você recebeu, você poderá pagar a diferença do valor excedido diretamente na loja.<br />Para utilizar o seu vale presentes, você deve inserir o código dele na página do seu Produtos para orçamento antes mesmo de finalizar o pedido.';
